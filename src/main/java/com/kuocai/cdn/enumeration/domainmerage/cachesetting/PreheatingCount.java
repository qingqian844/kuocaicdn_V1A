...
//    HUAWEI_VOLCENGINE(CdnRoute.HUAWEI_VOLCENGINE.getCode(), "20000"),
     ...
     * @return
     */
    public static PreheatingCount convert(String key) {
        return Arrays.stream(PreheatingCount.values())
                .filter(e -> Objects.equals(e.key, key))
                .findFirst()
                .orElse(PreheatingCount.HUAWEI);
    }
