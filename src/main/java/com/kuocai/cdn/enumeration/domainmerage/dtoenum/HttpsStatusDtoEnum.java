...
@Getter
@AllArgsConstructor
public enum HttpsStatusDtoEnum {

    /**
     * 开
     */
    ON("1", "1", "true", "null", "https", "1"),

    /**
     * 关
     */
    OFF("0", "0", "false", "null", "http", "0");
     ...
     * @return
     */
    public static HttpsStatusDtoEnum getOtherParam(String param) throws BusinessException {
        Optional<HttpsStatusDtoEnum> first = Arrays.stream(HttpsStatusDtoEnum.values())
    ...
    public static String getSelfParam(String param, CdnOperationRoute cdnOperationRoute) throws BusinessException {
        ...
        Optional<HttpsStatusDtoEnum> first = null;
        if(ObjectUtil.equal(route, CdnRoute.HUAWEI.getCode())){
            first = Arrays.stream(HttpsStatusDtoEnum.values())
