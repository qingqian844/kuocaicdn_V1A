...
@Getter
@AllArgsConstructor
public enum OriginTypeDtoEnum {

    IPADDR("ipaddr", "ipaddr", "ip", "ipaddr", "ip"),
     ...
     * @return
     */
    public static OriginTypeDtoEnum getOtherParam(String param) throws BusinessException {
        Optional<OriginTypeDtoEnum> first = Arrays.stream(OriginTypeDtoEnum.values())
    ...
    public static String getSelfParam(String param, CdnOperationRoute cdnOperationRoute) throws BusinessException {
        ...
        Optional<OriginTypeDtoEnum> first = null;
        if(ObjectUtil.equal(route, CdnRoute.HUAWEI.getCode())){
            first = Arrays.stream(OriginTypeDtoEnum.values())
